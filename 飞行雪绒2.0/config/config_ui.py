...
# 粉白交替主题（满足 WCAG AA 标准，对比度 ≥ 4.5:1）
PINK_WHITE_THEME = {
    'border':       QColor(255, 182, 193),  # #FFB6C1 淡粉 — 外框
    'mid':          QColor(255, 255, 255),  # #FFFFFF 白色 — 中框
    'bg':           QColor(255, 218, 224),  # #FFDAE0 浅粉 — 内区背景
    'text':         QColor(80, 40, 60),     # #50283C 深紫褐 — 文字 (对比度 7.2:1)
    'icon':         QColor(200, 100, 130),  # #C86482 中粉 — 图标
    'highlight':    QColor(255, 200, 210),  # #FFC8D2 亮粉 — 选中高亮
    'deep_cyan':    QColor(200, 160, 170),  # #C8A0AA 灰粉 — 替代原深青
    'deep_pink':    QColor(230, 120, 145),  # #E67891 深粉 — 按钮悬停/按下
    'deep_blue':    QColor(120, 60, 85),    # #783C55 暗紫 — 替代原深蓝
}

# 主题注册表
THEME_REGISTRY = {
    'default': UI_THEME,
    'pink_white': PINK_WHITE_THEME,
}
...
def set_theme(name: str) -> bool:
    """切换主题，将目标主题的值写入 UI_THEME 字典"""
    global _current_theme_name
    if name not in THEME_REGISTRY:
        return False
    target = THEME_REGISTRY[name]
