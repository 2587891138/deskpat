...
飞行雪绒是一个以 Windows 10/11 为主要目标平台的桌面宠物项目，围绕 **桌宠展示、AI 伴聊、语音播报、语音识别、音乐播放、可生成场景对象** 这几条主线持续迭代。`2.0` 版本是基于 LTS1.0.5pre2 的重大升级，重点聚焦功能扩展与架构优化。
...
`2.0` 是基于 LTS1.0.5pre2 的重大版本升级。详细变更将在开发过程中记录到 `CHANGELOG.md`。
